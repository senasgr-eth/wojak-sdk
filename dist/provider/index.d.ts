...
import type { CreateTxPayload, SendWithOpReturnOptions, InscribeBatchResult, InscribePayload, InscribeResult, InscribedTransferResult, MultiSignPsbtOptions, PresignBatchResult, SignPsbtOptions } from "./types";
/**
...
export interface IWojakProvider {
     ...
     */
    inscribeBatchPresign(payloads: InscribePayload[]): Promise<PresignBatchResult>;
